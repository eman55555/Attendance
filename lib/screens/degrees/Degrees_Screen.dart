  ...
  Widget buildRow() {
    return Container(
      ...
      child: Row(
        children: [
          buildCell(
              MediaQuery.of(context).size.width * .2, _register_data['class']!= null ?'${_register_data['class']}' :'',
              bkground: Colors.white),
          buildCell(MediaQuery.of(context).size.width * .2,
              '',
              bkground: Colors.white),
          buildicon(MediaQuery.of(context).size.width * .2,
              '${attendenceController.text}',
              bkground: Colors.white),
          buildCell(
              MediaQuery.of(context).size.width * .2, '${degreeController.text}',
              bkground: Colors.white),
        ],
      ),
    );
